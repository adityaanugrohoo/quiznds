...
type BangunRuangClient interface {
	...
	HitungKelilingPersegi(ctx context.Context, in *RequestKelilingkubus, opts ...grpc.CallOption) (*ResponseKelilingKubus, error)
...
func (c *bangunRuangClient) HitungKelilingPersegi(ctx context.Context, in *RequestKelilingkubus, opts ...grpc.CallOption) (*ResponseKelilingKubus, error) {
	out := new(ResponseKelilingKubus)
...
type BangunRuangServer interface {
	...
	HitungKelilingPersegi(context.Context, *RequestKelilingkubus) (*ResponseKelilingKubus, error)
...
func (UnimplementedBangunRuangServer) HitungKelilingPersegi(context.Context, *RequestKelilingkubus) (*ResponseKelilingKubus, error) {
...
func _BangunRuang_HitungKelilingPersegi_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BangunRuangServer).HitungKelilingPersegi(ctx, req.(*RequestKelilingkubus))
	}
	return interceptor(ctx, in, info, handler)
}
